                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Enter The Visitor ID To Delete!
                        </h1>
...
if (mysqli_connect_errno())
{
    echo "Failed to connect to Mysql: " . Mysqli_connect_error();
         ...
         if(isset($_POST['delete'])) {
            ...
            echo "<script>window.location='visitor list.php'</script>";
         }else {
            ?><center>
             <form method = "post" action = "<?php $_PHP_SELF ?>">
                  <table width = "400" border = "0" cellspacing = "1" 
                     ...
                     <tr>
                        ...
                        <br>
                        <td><input name = "visitor_id" type = "text" 
                           id = "visitor_id"  class="form-control" required></td>
                     </tr>
